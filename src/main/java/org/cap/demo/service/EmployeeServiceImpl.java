...
public class EmployeeServiceImpl implements EmployeeService {
	...
	private static List<Employee> dummyEmployeeList() {           //inserting the employee data
	...
	@Override
	public Employee findEmployee(int employeeId) {         //finds employee by id
	...
	@Override
	public List<Employee> deleteEmployee(int employeeId) {      //deletes employee by id 
